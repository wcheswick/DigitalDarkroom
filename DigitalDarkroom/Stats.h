...
@interface Stats : NSObject {
    ...
    int depthCopies, pixbufCopies, tooBusyForAFrame;
    int incomingFrameMissing;
    NSString *status;
...
@property (assign)              int depthCopies, pixbufCopies, tooBusyForAFrame;
@property (assign)              int incomingFrameMissing;
